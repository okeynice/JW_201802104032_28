...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div>\n  <br>\n  <button > 添加学院</button>\n</div>\n\n<table class=\"tablelist\">\n  <tr><th>姓名</th><th>学位</th><th>专业</th><th>职位</th><th>ID</th><th>操作</th></tr>\n  <tr *ngFor=\"let teacher of teachers\" class=\"badge\">\n    <td>{{teacher.name}}</td>\n    <td>{{teacher.degree.id}}</td>\n    <td>{{teacher.department.id}}</td>\n    <td>{{teacher.title.id}}</td>\n    <td>{{teacher.id}}</td>\n    <td><button class=\"delete\" >修改</button><button class=\"delete\" >删除</button></td>\n  </tr>\n</table>\n");
...
let SchoolService = class SchoolService {
    ...
    deleteCollege(college) {
        ...
        return this.http.delete(this.collegeUrl + 'delete.ctl?id=' + id, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteCollege')));
    }
...
let TeacherService = class TeacherService {
    constructor(http) {
        this.http = http;
        this.collegeUrl = '../teacher/list.ctl';
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* schoolesComponent's private CSS styles */\r\n.tablelist{ width:1000px; border:0; mso-cellspacing: 0; margin-top:30px; }\r\n.tablelist tr{\r\n  background-color: dimgray;\r\n  line-height:30px;\r\n  color: white;\r\n}\r\n.tablelist .badge{\r\n  background-color:#eef;\r\n  line-height:30px;\r\n  color:#000;\r\n  text-align: center;\r\n}\r\n.tablelist .badge:hover {\r\n  color: #039be5;\r\n  background-color: #DDD;\r\n  left: .1em;\r\n}\r\n.tablelist td { border-bottom:2px dashed #888;}\r\n.tablelist a {\r\n  color: #333;\r\n  text-decoration: none;\r\n}\r\n.tablelist a:hover {\r\n  color:#607D8B;\r\n}\r\nbutton {\r\n  background-color: gray !important;\r\n  color: white;\r\n  border: none;\r\n  padding: 5px 5px;\r\n  border-radius:3px;\r\n  margin-right: 10px;\r\n  cursor:hand;\r\n}\r\nbutton:hover {\r\n  background-color: #cfd8dc;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
